...
# Define the directory installing (and running) a local Ghost instance:
GHOST_DIR ?= $(ROOT_DIR)/ghost

# Define the directory containing the Ghost theme:
